                  ...
                  <div className="profile-card__cnt js-profile-cnt">
                    ...
                    <div className="profile-card-inf">
                      <div className="profile-card-inf__item">
                        <div className="profile-card-inf__title">{`$ ${StockData.cash}`}</div>
                        <div className="profile-card-inf__txt">Cash</div>
                      </div>
                      <div className="profile-card-inf__item">
                        <div className="profile-card-inf__title">{`$ ${StockData.cashInvested}`}</div>
                        <div className="profile-card-inf__txt">Cash invested</div>
                      </div>
                      <div className="profile-card-inf__item">
                        <div className="profile-card-inf__title">{StockData.numberOfOffers}</div>
